...
describe("formatPhone", () => {
  test("should format phone numbers correctly", () => {
    ...
    expect(formatPhone("+251912345678", "local")).toBe("0912345678"); // Already formatted number
    expect(formatPhone("251912345678", "local")).toBe("0912345678"); // Missing '+'
    ...
    expect(formatPhone("912345678", "local")).toBe("0912345678"); // 9-digit  ethio-tel number, missing '+251'
    expect(formatPhone("712345678")).toBe("+251712345678"); // 9-digit  safari number, missing '+251'
    expect(formatPhone("1234567890", "local")).toBe("INVALID_PHONE_NUMBER"); // INVALID_PHONE_NUMBER
